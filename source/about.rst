...
Version 0.4, not released yet.
  ...
  hw-sw-stack.rst: Refine the VSync section.
  Correct typos.
...
Version 0.2, Released February 28, 2026.

  Reorganize sections.

Version 0.1, Released February 22, 2026.
...
This book provides an overview of how 3D animation is created and executed on
a CPU–GPU system. It then introduces GPU compilers and hardware
features relevant to graphics applications. Finally, it explains how GPUs have
taken on computational tasks traditionally handled by CPUs through the GPGPU
(general-purpose computing on graphics processing units) concept and related
standards.
